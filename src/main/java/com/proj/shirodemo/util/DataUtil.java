...
public final class DataUtil {
    ...
    /**
     * 把Map<String, Object> 转成 Map<String, String>
     *
     * @param params
     * @return
     */
    public static Map<String, String> mapConvert(Map<String, Object> params) {
        if (isEmpty(params)) {
            return null;
        }
     ...
     * @param bytes
     */
    public static String gzipToString(byte[] bytes) {
        ...
        try {
            ...
            try {
                ...
                log.error("BufferedReader 关闭异常", e);
            }
            try {
                if (gzip != null) {
                    gzip.close();
                ...
                log.error("GZIPInputStream 关闭异常", e);
            }
        }
        return "";
    }
